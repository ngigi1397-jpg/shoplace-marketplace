            ...
            <>
              ...
              <div className="shops-grid">
                {filtered.map(s => (
                  <div
                    key={s.id}
                    className={"shop-card" + (s.is_verified === true ? " verified-card" : "")}
                  ...
                  >
                          ...
                          <svg width="28" height="28" viewBox="0 0 220 220" fill="none">
                            <defs>
                              <linearGradient id={"bg"+s.id} x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="#FF8040"/><stop offset="50%" stopColor="#FF5566"/><stop offset="100%" stopColor="#FF2880"/>
                              </linearGradient>
                            </defs>
                    ...
                    {s.description && <div className="shop-desc">{s.description.slice(0, 70)}{s.description.length > 70 ? "..." : ""}</div>}
...
.shop-card{background:white;border-radius:18px;padding:1.4rem;border:1px solid var(--border);cursor:pointer;transition:all .25s;position:relative;overflow:hidden;}
...
.verified-ribbon{display:inline-flex;align-items:center;gap:0.3rem;padding:0.22rem 0.7rem;background:linear-gradient(135deg,#ff8c42,#ff4e8c);border-radius:100px;font-size:0.65rem;font-weight:700;color:white;box-shadow:0 2px 10px rgba(255,80,60,0.45);width:fit-content;margin-bottom:0.8rem;}
...
.shop-top{display:flex;align-items:center;justify-content:space-between;margin-bottom:0.9rem;}
...
.shop-name{font-family:'Syne',sans-serif;font-size:1rem;font-weight:800;margin-bottom:0.4rem;}
.verified-card .shop-name{color:white;}
.shop-desc{font-size:0.78rem;color:rgba(13,13,13,0.45);line-height:1.5;margin-bottom:0.6rem;}
.verified-card .shop-desc{color:rgba(255,255,255,0.38);}
.shop-meta-row{display:flex;align-items:center;gap:0.5rem;flex-wrap:wrap;margin-bottom:0.4rem;}
...
.shop-phone{font-size:0.72rem;color:rgba(13,13,13,0.3);margin-bottom:0.6rem;}
.verified-card .shop-phone{color:rgba(255,255,255,0.2);}
.shop-footer{margin-top:0.8rem;padding-top:0.8rem;border-top:1px solid var(--border);}
