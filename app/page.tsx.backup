...
@media(max-width:768px){
  ...
  .sp-nav-actions .btn-ghost:not(:last-child){display:none;}
  .sp-hero{grid-template-columns:1fr;min-height:auto;padding-top:70px;}
  ...
  .sell-banner{flex-direction:column;text-align:center;padding:2rem 1.2rem;gap:1.2rem;}
  .sell-banner .btn-solid-white{width:100%;justify-content:center;}
